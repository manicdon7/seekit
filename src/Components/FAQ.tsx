    ...
    return (
        <div className='mx-10 lg:my-20'>
            ...
            <div className='mx-20'>
                ...
                <div className='grid lg:grid-cols-4 grid-cols-1 gap-8 justify-center mx-10 mb-10 lg:mb-0'>
                    {/* <div className="card">
                <div className="bg">
                ...
                <div className="blob"></div>
                    ...
                    <div className="card">
                        <div className="bg">
                            ...
                            <div className='pt-10 flex justify-evenly px-2'>
                                <div>
                                    <h1 className='text-lg text-white font-medium'>Where to post found things in Seekit ? </h1>
                                </div>
                                <Link href='/found'>
                                    <div className='pt-16'>
                                        <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 8 8"><path fill="white" d="M5 1v2H0v1h5v2l3-2.53z" /></svg>
                    ...
                    <div className="card">
                        <div className="bg">
                            ...
                            <div className='pt-10 flex justify-evenly px-2'>
                                <div>
                                    <h1 className='text-lg text-white font-medium'> Where to post my losted things in Seekit ? </h1>
                                </div>
                                <Link href='/lost'>
                                    <div className='pt-16'>
                                        <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 8 8"><path fill="white" d="M5 1v2H0v1h5v2l3-2.53z" /></svg>
                    ...
                    <div className="card">
                        <div className="bg">
                            ...
                            <div className='pt-10 flex justify-evenly px-2'>
                                <div>
                                    <h1 className='text-lg text-white font-medium'>Where to Seek Things in Seekit ? </h1>
                                </div>
                                <Link href='/seek'>
                                    <div className='pt-16'>
                                        <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 8 8"><path fill="white" d="M5 1v2H0v1h5v2l3-2.53z" /></svg>
                    ...
                    <div className="card">
                        <div className="bg">
                            ...
                            <div className='pt-10 flex justify-evenly px-2'>
                                <div>
                                    <h1 className='text-lg text-white font-medium'>Where to see My posts in Seekit ?</h1>
                                </div>
                                <Link href='/myposts'>
                                    <div className='pt-16'>
                                        <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 8 8"><path fill="white" d="M5 1v2H0v1h5v2l3-2.53z" /></svg>
